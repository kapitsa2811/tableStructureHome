...
hocrPaths="/home/kapitsa/PycharmProjects/objectLocalization/wsl/tableStructure/publicationData/8/tableRelatedAll/delMe//tableHocr//"
#hocrPaths="/home/kapitsa/PycharmProjects/objectLocalization/wsl/tableStructure/publicationData/8/tableRelatedAll/delMe//testTableHocr//"
...
# hocrPaths="./newImages/trainHocr1//"
# imagePath="./newImages/train1//"
...
for indx,imageName in enumerate(imageNames):
    ...
    baseImageName=copy.deepcopy(out1)
    ...
    print("\n\t is file:",os.path.isfile(hocrPaths+baseImageName+".txt.hocr"))
    root = parse(hocrPaths+baseImageName+".txt.hocr")

    flag=1
    # if os.path.isfile(hocrPaths+baseImageName+".txt.hocr"):
    #     flag=0
    #     print("\n\t flag:", flag)
    #     print("+++++++++++++++++++++")
    #     continue
    ...
    for indx,ocrWord in enumerate(ocrWords):
      ...
      if node != None:
        ...
        try:
            ...
            #image=drawRect((x1,y1), (x2,y2),image)
            #show(image, imageName,[500,500],[0,200],100,1)
    ...
    #writeFile(image,"/home/kapitsa/PycharmProjects/objectLocalization/wsl/tableStructure/publicationData/8/tableRelatedAll/delMe//hocrMaps//" + imageName)
    #print("\n\t totalLineCount=",totalLineCount)
    #input("check")
    #print ("\n\t out1=",out1)

output.to_csv(tempPath+"trainOut.csv",encoding='utf-8',index=False)
